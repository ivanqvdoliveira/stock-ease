          ...
          <form class="form-custom">
            ...
            <div class="relative">
              ...
              <input
                type="search"
                id="default-search"
                class="block w-full p-[14px] ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                placeholder="Buscar produto, fornecedor, categoria..."
                bind:value={searchValue}
                on:change={(e) => onSearchItem(e.target.value)}
                on:keypress={(e) => onKeyPress(e)}
              />
              <button type="submit" class="text-white absolute end-2.5 bottom-[7px] bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 ">Search</button>
            </div>
        </form>
